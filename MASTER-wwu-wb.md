...
- [SPEC — Withdrawal exemptions (Art. 59)](docs/specs/wwu-wb-withdrawal-exemptions-SPEC.md) — exempting products/services with the legal consent-capture conditions; exception-type registry + admin UI + **P2 WooCommerce checkout consent capture shipped** (alpha.28). FluentCart checkout capture + P3 transparency remain (2026-06-14).
